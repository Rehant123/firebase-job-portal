...
import getdatacustom from ".././hooks/useGetdata"
const Searchbar = () => {
    ...
    async function handleSubmit(){
        const red = {...jobCriteria}
       getdatacustom({title:red.title,location:red.location,experience:red.experience,type:red.type});
  ...
  return (
    ...
    <button  onClick = {handleSubmit} className='w-64 bg-blue-500 text-white font-bold py-3 rounded-md'>Search</button>
</div>
  )
}
